...
public class EditContactServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String contactId = null, contactName = null, email = null, phnNo = null, gender = null, dob = null, city = null,
				state = null, country = null, company = null, address = null, contactFlag = "true";
		Blob blob = null;
		byte[] photoData = null;
		...
		while (iter.hasNext()) {
			...
			// processes only fields that are not form fields
			if (item.isFormField()) {
				if (item.getFieldName().equals("contactFlag")) {
					contactFlag = item.getString();
				}
		...
		try {
			if (contactFlag.equals("true")) {
				System.out.println("Inside EditContac Servlet : flag value: "+contactFlag +" upadting existing image");
				ContactService cs = new ContactService();
				Contact currentContact = cs.getContactDetails(contactId, user.getUserId());
				blob = currentContact.getProfileImage();
			} else {
				System.out.println("Inside EditContac Servlet : flag value: "+contactFlag +" upadting new image");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out
				.println("INside DoGet EdtCOntact servlet , recieved contact id: " + request.getParameter("contactId"));
		// creating new session object to get current user object's username
		HttpSession session = request.getSession();
