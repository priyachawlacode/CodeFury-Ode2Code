<%@ page language="java" contentType="text/html;charset=ISO-8859-1"
	...
	import="com.hsbc.networking.service.AdminService, java.lang.*"%>
						...
						<div class="table-responsive">
							<table class="table  table-striped table-dark">
								...
								<tbody>
									...
									%>
									<%
									Integer d = (Integer) session.getAttribute("disableUsers");
									%>
									<c:forEach var="i" begin="0" end=d>
										<tr>
											<th scope="row">
												<%
											...
											<td>
												<form action="DisableServlet" method='POST'>		
													<button type='submit' name="Disable" class='btn btn-warning' value=${session.getAttribute('UserId')}>Disable</button>
												</form>
											</td>
						...
						<div class="table-responsive">
							<table class="table  table-striped table-dark">
                                ...
                                <td><button class="btn btn-danger">Delete</button></td>
									...
									%>
									<%
									Integer del = (Integer) session.getAttribute("deleteUsers");
									%>
									<c:forEach var="i" begin="0" end=del>
										<tr>
											<th scope="row">
												<%
											...
											<td>
												...
												%>
													...
													<button type='submit' name="Delete" class='btn btn-warning' value=${session.getAttribute('UserId')}>Delete</button>
												</form>
                                                                                        </td>
										</tr>
									</c:forEach>
